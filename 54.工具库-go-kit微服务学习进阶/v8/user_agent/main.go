...
import (
	...
	"my-gotools/54.工具库-go-kit微服务学习进阶/v8/user_agent/src"
	"my-gotools/54.工具库-go-kit微服务学习进阶/v8/utils"
	"net"
	"net/http"
	"os"
	"os/signal"
...
var prometheusAddr = flag.String("p", "192.168.2.28:10001", "46.工具库-简单的prometheus库示例 addr")
...
func main() {
	...
	go func() {
		utils.GetLogger().Info("[user_agent] 46.工具库-简单的prometheus库示例 run " + *prometheusAddr)
		m := http.NewServeMux()
