...
func InitHttpServer() {
	//curl  http://0.0.0.0:9999/push/all -X POST -d "val=test 51.工具库-简单的push推送服务&tag=3"
	//curl  http://0.0.0.0:9999/push/room -X POST -d "val=test 51.工具库-简单的push推送服务&tag=3&id=1"
	...
	mux.HandleFunc("/51.工具库-简单的push推送服务/all", HttpPushAll)
	mux.HandleFunc("/51.工具库-简单的push推送服务/room", HttpPushRoom)
